...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExceed> getFilteredWithExceeded(Collection<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        return mealList.stream()
                ...
                .map(um ->
                        createWithExceed(um,caloriesSumByDate.get(um.getDateTime().toLocalDate()) > caloriesPerDay))
    ...
    public static List<UserMealWithExceed> getFilteredWithExceededByCycle(List<UserMeal> mealList, LocalTime startIime, LocalTime endTime,int caloriesPerDay){
        ...
        for(UserMeal meal : mealList){
            ...
            if (TimeUtil.isBetween(dateTime.toLocalTime(),startIime,endTime)){
